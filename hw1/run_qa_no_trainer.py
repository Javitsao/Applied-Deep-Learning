...
def main():
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        #sourceFile = open('loss.txt', 'w')
        sourceFile = open('em.txt', 'w')
        for step, batch in enumerate(active_dataloader):
            with accelerator.accumulate(model):
                ...
                if args.with_tracking:
                    ...
                    #if step % 100 == 0:
                        #logger.info("lossssssss", loss)
                        #print("loss: ", loss, file = sourceFile)
            ...
            if step % 100 == 0:
                ...
                print(f"Evaluation metrics: {eval_metric}", file=sourceFile)
        ...
        if args.checkpointing_steps == "e poch":
    ...
    print(prediction.predictions, file = sourceFile)
    sourceFile.close()
