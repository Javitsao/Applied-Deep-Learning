...
def main():
    ...
    model.eval()
    output_list = []  # Initialize an empty list to store the predictions
    for step, batch in enumerate(eval_dataloader):
        ...
        output_list.append(predictions.item())  # Append the prediction to the list

    #print(output_list)
    # Write the list of predictions to the file
    with open("test_output_test.txt", "w") as file:
